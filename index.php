...
$sql="INSERT INTO `ngo``cont`(`Name`, `Email`, `Message`) VALUES ('$name', '$email', '$message')";
...
<body>
  ...
  <div class="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
    ...
    <a class="flex order-first lg:order-none lg:w-1/5 title-font font-medium items-center text-gray-900 lg:items-center lg:justify-center mb-4 md:mb-0">
      ...
      <div id="fo">
      <span class="ml-3 text-xl font-extrabold text-cyan-700 zoom"> &#129503 FOrtunate FUture</span>
      </div> 
    </a>
  ...
  <div class="container px-5 py-24 mx-auto flex flex-col" data-aos="flip-left"
    ...
    <div class="lg:w-4/6 mx-auto">
      <div class="rounded-lg h-64 overflow-hidden">
        ...
        <img alt="content" class="object-cover object-center h-full w-full" src="pic.jpg">
      </div>
      ...
      <div class="flex flex-col sm:flex-row mt-10">
        ...
        <div class="sm:w-1/3 text-center sm:pr-8 sm:py-8">
          ...
          <div id="f">
            <h2 class="font-medium title-font mt-4 text-green-900 text-lg font-extrabold text-brown-900"> <div id="f"> &#129503 FO-FU </h2>
           </div>

            
            <div class="w-12 h-1 bg-indigo-500 rounded mt-2 mb-4"> </div>
            <div id="kk">  
            <p class="text-base font-bold text-green-500">Welcome to FO-FU NGO Organisation 🤗. Here FO refers to Fortunate and FU refers to Future.</p>
            </div>
          </div>
        </div>
        <div class="sm:w-2/3 sm:pl-8 sm:py-8 sm:border-l border-gray-200 sm:border-t-0 border-t mt-4 pt-4 sm:mt-0 text-center sm:text-left">
          <div id="txt">
          <p class="leading-relaxed text-lg mb-4 text-gray-100">This organisation is supported by AnsrCoach team. The HOD of FO-FU NGO is Mr.Aniket Kumar. We utilise already available resources near the villages and slums for these children. The idea is to reach maximum number of children whose parents are not more or any other problem. We don’t just focus on academic teaching, but also engage these children in sports and extracurricular activities ✔️.
    ...
    <div class="flex flex-wrap md:-m-2 -m-1">
      <div class="flex flex-wrap w-1/2">
        <div class="md:p-2 p-1 w-1/2">
          <img alt="gallery" class="w-full object-cover h-full object-center block cur transitions" src="g1.jpeg">
        </div>
        <div class="md:p-2 p-1 w-1/2">
          <img alt="gallery" class="w-full object-cover h-full object-center block cur transitions" src="g4.jpeg">
        </div>
        <div class="md:p-2 p-1 w-full">
          <img alt="gallery" class="w-full h-full object-cover object-center block cur transitions" src="g6.jpeg">
        </div>
      </div>
      <div class="flex flex-wrap w-1/2">
        <div class="md:p-2 p-1 w-full">
          <img alt="gallery" class="w-full h-full object-cover object-center block cur transitions" src="dd.jpeg">
        </div>
        <div class="md:p-2 p-1 w-1/2">
          <img alt="gallery" class="w-full object-cover h-full object-center block cur transitions" src="g10.jpeg">
        </div>
        <div class="md:p-2 p-1 w-1/2">
          <img alt="gallery" class="w-full object-cover h-full object-center block cur transitions" src="g11.jpeg">
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="flex flex-wrap -m-2">
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-blue-700 border-4 p-4 rounded-lg border-double fade cur">
          ...
          <div class="flex-grow">
            <h2 class="text-blue-700 title-font font-extrabold">Aniket Kumar</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-yellow-700 border-4 p-4 rounded-lg border-double fade cur">
          ...
          <div class="flex-grow">
            <h2 class="text-yellow-700 title-font font-extrabold">Gaurav Verma</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-pink-700 border-4 p-4 rounded-lg border-double fade cur">
          <img alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="guppi.jpeg">
          <div class="flex-grow">
            <h2 class="text-pink-700 title-font font-extrabold">Gurpreet Maini</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-white-700 border-4 p-4 rounded-lg border-double fade cur">
          ...
          <div class="flex-grow">
            <h2 class="text-yellow-200 title-font font-extrabold ">Ishan Mongia</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-red-500 border-4 p-4 rounded-lg border-double fade cur">
          <img alt="team" class="w-16 h-16 bg-yellow-200 object-cover object-center flex-shrink-0 rounded-full mr-4" src="vipul.jpeg">
          <div class="flex-grow">
            <h2 class="text-red-500 title-font font-extrabold">Vipul Mongia</h2>
      ...
      <div class="p-2 lg:w-1/3 md:w-1/2 w-full">
        <div class="h-full flex items-center border-green-700 border-4 p-4 rounded-lg border-double fade cur">
          <img alt="team" class="w-16 h-16 bg-gray-100 object-cover object-center flex-shrink-0 rounded-full mr-4" src="preeti.jpeg">
          <div class="flex-grow">
            <h2 class="text-green-700 title-font font-extrabold ">Preeti Sahni</h2>
    ...
    <div class="lg:w-1/2 md:w-2/3 mx-auto">
      <div class="flex flex-wrap -m-2">
        ...
        <div class="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
          <a class="text-black font-bold">kumaraniket62262@gmail.com</a>
          <p class="leading-normal my-5 font-bold text-black">8427621239
          </p>
          <span class="inline-flex">
            <a class="text-blue-700 iko">
              <svg fill="currentColor"stroke-linecap="round" stroke-linejoin="round" stroke-width="2" class="w-5 h-5" viewBox="0 0 24 24">
                <a href="https://www.facebook.com/aniket.sak.9">
